...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 text-foreground font-sans selection:bg-primary/20">
      ...
      <div className="flex-1 flex flex-col h-screen md:pl-56">
        {/* Full-width header */}
        <header className="h-10 bg-[#012e28] text-white flex items-center justify-between px-4 md:px-6 border-b border-white/10 sticky top-0 z-40 w-full left-0 md:left-56 right-0">
