...
// // This is the key that prevents dashboard overlap. 
// // Change this to something different in your Admin/Creator dashboard to keep them separate.
...
//     // Saves to the UNIQUE STORAGE_KEY
...
//         href: `/creator-dashboard/users/${creator.id}`,
//       }));
...
//           href: `/creator-dashboard/collabs/${collab.id}`,
//         });
...
//           </Button>
//           <div className="bg-slate-50 dark:bg-slate-900 p-6 rounded-xl border flex items-center gap-4">
//             <div className="h-16 w-16 rounded-full bg-orange-100 flex items-center justify-center">
//               <MapPin className="h-8 w-8 text-orange-600" />
//             </div>
//             <div>
//               <h2 className="text-2xl font-bold">{selectedVenue}</h2>
//               <p className="text-slate-500">Collaborations at this location</p>
//             </div>
//           </div>
...
//             <TabsTrigger value="collaborations">Collabs</TabsTrigger>
//             <TabsTrigger value="venues">Venues</TabsTrigger>
//           </TabsList>
//           <TabsContent value="all" className="space-y-4">{results.map(renderResultItem)}</TabsContent>
//           <TabsContent value="creators" className="space-y-4">{results.filter(r => r.type === 'creator').map(renderResultItem)}</TabsContent>
//           <TabsContent value="collaborations" className="space-y-4">{results.filter(r => r.type === 'collaboration').map(renderResultItem)}</TabsContent>
//           <TabsContent value="venues" className="space-y-4">{results.filter(r => r.type === 'venue').map(renderResultItem)}</TabsContent>
//         </Tabs>
//       )}
...
//                  <Badge 
//                     variant="secondary" 
//                     className="cursor-pointer px-4 py-2 pr-8"
...
//             <Button variant="link" size="sm" onClick={clearAllSearches} className="text-slate-400">Clear all</Button>
//           )}
//         </div>
//       )}
//     </div>
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            {['all', 'upcoming', 'ongoing', 'past'].map((tab) => (
              <TabsContent key={tab} value={tab} className="space-y-2 mt-0">
                {filteredByVenue.filter(c => tab === 'all' || c.status === tab).map(renderResultItem)}
                {filteredByVenue.filter(c => tab === 'all' || c.status === tab).length === 0 && (
                  <div className="text-center py-10 text-slate-500 text-xs italic">No {tab} collaborations found here.</div>
                )}
              </TabsContent>
            ))}
          </Tabs>
